...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 15, 2020 at 08:15 PM
...
INSERT INTO `client` (`id`, `nom`, `prenom`, `email`, `address`, `telephone`, `user`) VALUES
(4, 'l', 'k', 'gk_mahboubi@esi.dz', 'k', 'k', 'dlkjh'),
(5, 'dlkfdskjkd', 'kjdkjlslk', 'gk_mammhboubi@esi.dz', 'lewkfdslkf', 'slk', 'rootskdks'),
(6, 'kwther', 'lk', 'gk_mahkkboubi@esi.dz', 'qlqlpw[', '2938430', 'password'),
(7, 'dsdksd', 'fjkhdsfjk', 'gk_mahbofefeubi@esi.dz', '', '', 'wesgfiuhw'),
(8, ';ljgjkcgf', 'kjljhjhg', 'k@kf.dz', ';LKJKBJB', 'KNKK', 'kj;lkjhg'),
(9, 'farah', 'nedjmeddine', 'colla', '789878', '+213798794916', 'nayone');
...
CREATE TABLE `devis` (
  ...
  `id_traducteur` int(10) UNSIGNED NOT NULL,
  `date` date NOT NULL,
...
INSERT INTO `language` (`id`, `des`) VALUES
(1, 'Arabe'),
(4, 'Français'),
(5, 'Anglais'),
(6, 'Turque'),
...
INSERT INTO `traducteur` (`id`, `Nom`, `Prenom`, `wilaya`, `commune`, `Adresse`, `Telephone`, `Fax`, `user`, `note`) VALUES
(26, 'Benouadah', 'merzak', 15, 502, '05 Rue des martyrs.', '021 56 25 70', '021 56 30 50 / 56 51 54', '6', 0),
(25, 'Hazi', 'Farouk', 15, 490, '10 Rue des oliviers', '025 56 25 70', '025 56 30 50', '5', 0),
(24, 'Sebaa', 'Djamila', 39, 1305, '30 Rue des dunes', '026 56 25 70', '026 56 30 50', '4', 0),
(23, 'Bouroubi', 'Taous', 16, 568, '68 rue de la gare', '023 56 25 70', ' 023 56 30 50', '3', 0),
(22, 'Helali', 'Karim', 35, 1198, '3500 Rue de la liberté', '035 56 25 70', '035 56 30 50', '2', 0),
(21, 'Belhadj', 'Said', 31, 1114, '50 Rue des martyrs', '031 56 25 70', '031 56 30 50 ', '1', 0);

-- --------------------------------------------------------

--
-- Table structure for table `traduirea`
--

CREATE TABLE `traduirea` (
  `id` int(10) UNSIGNED NOT NULL,
  `language` int(11) NOT NULL,
  `traducteur` int(11) NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;

--
-- Dumping data for table `traduirea`
--

INSERT INTO `traduirea` (`id`, `language`, `traducteur`) VALUES
(1, 1, 21),
(2, 4, 21),
(3, 5, 21),
(4, 1, 22),
...
--
-- Table structure for table `type_traduction`
--
...
--
-- Dumping data for table `type_traduction`
--

INSERT INTO `type_traduction` (`id`, `des`) VALUES
(1, 'général'),
(2, 'scientifique'),
(6, 'site web');
...
CREATE TABLE `users` (
  ...
  `traducteur` tinyint(1) NOT NULL DEFAULT '0',
...
INSERT INTO `users` (`id`, `username`, `pwd`, `traducteur`, `admin`, `blocked`) VALUES
(1, 'S_Belhadj', '123', 1, 0, 0),
(2, 'k_Helali', '123', 1, 0, 0),
(3, 't_Bouroubi', '123', 1, 0, 0),
(6, 'm_Benouadah', '123', 1, 0, 0),
(4, 'd_Sebaa', '123', 1, 0, 0),
(5, 'F_Hazi', '123', 1, 0, 0),
(7, 'root', '123', 0, 1, 0),
(19, 'rootskdks', 'klj', 0, 0, 0),
(18, 'dlkjh', 'k', 0, 0, 0),
(17, 'd', 'o', 0, 0, 0),
(20, 'password', 'weeew', 0, 0, 0),
(21, 'wesgfiuhw', 'efkfkjshshfj', 0, 0, 0),
(22, 'nay', 'admin', 0, 0, 0),
(23, 'nayone', '789878', 0, 0, 0);
...
ALTER TABLE `devis`
  ADD PRIMARY KEY (`id`),
  ADD KEY `traducteur` (`id_traducteur`),
...
--
-- Indexes for table `traduirea`
--
ALTER TABLE `traduirea`
  ADD PRIMARY KEY (`id`),
  ADD KEY `language` (`language`),
  ADD KEY `traducteurLanguage` (`traducteur`);
...
--
-- Indexes for table `type_traduction`
--
ALTER TABLE `type_traduction`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `traduirea`
--
ALTER TABLE `traduirea`
...
--
ALTER TABLE `type_formation`
  MODIFY `Id_type_formation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `type_traduction`
--
ALTER TABLE `type_traduction`
